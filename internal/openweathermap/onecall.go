// Original Source: https://github.com/briandowns/openweathermap/blob/73fe5d9de2043e6c5e16384a0bce9ae8e29caf53/onecall.go
// This is from an unmerged PR request, I made minor changes for this demo
...
func (oc *OneCallData) PerformOneCall(coords *Coordinates) error {
	params := fmt.Sprintf("appid=%s&lat=%f&lon=%f&units=%s&lang=%s", oc.Key, coords.Latitude, coords.Longitude, oc.Unit, oc.Lang)
	if oc.Excludes != "" {
