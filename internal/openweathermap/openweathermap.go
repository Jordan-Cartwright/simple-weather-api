// Source: https://github.com/briandowns/openweathermap
// Using part of the code here so that I may use an unpublished PR
// for interacting with the onecall endpoint (Dark Sky API replacement)
